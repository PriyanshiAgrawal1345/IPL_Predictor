...
def toss_predictor():
    def predict_toss():
        ...
        team1 = team_1_dropdown
        team2 = team_2_dropdown
        toss_decision = toss_decision_var.get()

        input_data = pd.DataFrame([[team1, team2, toss_decision]], columns=X_encoded.columns)
    ...
    predict_button = tk.Button(root, text='Predict', command=predict_toss)
    predict_button.pack()
